...
- Start API + web with `scripts/dev.ps1` (Windows) or `scripts/dev.sh` (macOS/Linux). Run Android on an emulator with `scripts/android.ps1` / `scripts/android.sh`. See the README Run section.
